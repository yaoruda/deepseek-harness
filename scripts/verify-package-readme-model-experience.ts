...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-connection-recovery': { kind: 'none', reason: 'Browser-side connection recovery UI; registers nothing model-facing.' },
  ...
  'packages/client/ui-display-density': { kind: 'none', reason: 'Browser-side display preference; registers nothing model-facing.' },
  'packages/client/ui-skin-presets': { kind: 'none', reason: 'Browser-side fixed palettes; registers nothing model-facing.' },
